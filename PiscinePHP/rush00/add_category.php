...
<div class=pageback>
    ...
    <div class=backcontent>
        <form class="backdivbg" action="create_category.php" method="post">
        <p>
            <?php
            if(isset($_GET["action"]) && $_GET["action"] === "create")
                echo("<div class=msgsucces><a>Your category has been created ! Yupi !</a></div>");
            else if(isset($_GET["action"]) && $_GET["action"] === "error")
                echo("<div class=msgerror><a>ERROR : Invalid field ?</a></div>");
            ?>
